...
urlpatterns = [
    ...
    path('toggle-field-status/<int:id>/', views.toggle_field_status, name='toggle_field_status'),
    ...
    path('toggle-fixed-value/<int:id>/', views.toggle_fixed_value,            name='toggle_fixed_value'),

    # ── SUPPLIER MASTER ───────────────────────────────
    path('supplier-master/',             views.supplier_master,  name='supplier_master'),
    path('toggle-supplier-status/<int:id>/', views.toggle_supplier_status,   name='toggle_supplier_status'),

    # ── RAW MATERIAL MASTER ───────────────────────────
    path('raw-material-master/',          views.raw_material_master,  name='raw_material_master'),
    path('toggle-raw-material-status/<int:id>/', views.toggle_raw_material_status, name='toggle_raw_material_status'),

    # ── JOINT TYPE MASTER ─────────────────────────────
    path('joint-type-master/',            views.joint_type_master,  name='joint_type_master'),
    path('toggle-joint-type-status/<int:id>/',  views.toggle_joint_type_status,   name='toggle_joint_type_status'),
    
    # ROLE MASTER
    path('role-master/', views.role_master, name='role_master'),

    # ── REPORTS ───────────────────────────────────────
    path('master-report/', views.master_report, name='master_report'),


    path('format-master/',                    views.format_master,             name='format_master'),
    path('download-pdf/<int:id>/',            views.download_tool_request_pdf, name='download_tool_request_pdf'),
]